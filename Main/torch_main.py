...
import datetime 
from Metrics.losses import DiceLoss, DiceBCELoss, IoULoss
...
class Config():
    def __init__(self,image_size,device):
        self.data = self.Data(image_size)
        self
...
def train(model_name, model, optimizer, criterion, loss_name,train_loader, val_loader, device, num_epochs, clear_mem):
...
loss_name = 'DiceBCE'
num_epochs = 4
results = train(model_name,model,optimizer,criterion,loss_name,

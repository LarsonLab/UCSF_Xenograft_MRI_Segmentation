...
from .aux.vision_lstm import ViLBlock, SequenceTraversal 
...
class UNetResDecoder(nn.Module):
        ...
        for s in range(1,n_stages_encoder):
            ...
            stages.append(nn.Sequential(
                BasicResBlock(
                    ...
                    normm_op_kwargs = encoder.norm_op_kwargs,
    ...
    def compute_conv_feature_map_size(self,input_size):
        ...
        for s in range(len(self.stages)):
            ...
            output += np.prod([self.encoder.output_channels[-(s+2)]],dtype=np.int64)
        return output 
